...
class RNN_model(nn.Module):
    def __init__(self, batch_sz ,vocab_len ,word_embedding,embedding_dim, lstm_hidden_dim):
        ...
        # ???
        self.rnn_lstm = nn.LSTM(self.word_embedding_dim,self.lstm_dim,2,batch_first=True)
    ...
    def forward(self,sentence,is_test = False):
        ...
        # ???
        output,ex=self.rnn_lstm(batch_input,(torch.zeros(2,1,self.lstm_dim),torch.zeros(2,1,self.lstm_dim)))
